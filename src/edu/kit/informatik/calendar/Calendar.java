...
public final class Calendar {
    ...
    /**
     * Get the {@linkplain Appointment} instances stored in this that start before a given {@linkplain DateTime} instance
     * @param pointOfTime The given instance
     * @return An iterator associated to the set of {@linkplain Appointment} instances which start before the given {@linkplain DateTime} instance
     */
     ...
     * @return An iterator associated to the set of {@linkplain Appointment} instances which start and end in the given day
     */
     ...
     * @return A {@linkplain Appointment} instance with the given name. {@value Null} if such instance isn't stored in this
     */
    ...
    /**
     * Get the {@linkplain Appointment} instances stored in this that conflict with a given {@linkplain Appointment} instance, which is stored in this too. 
